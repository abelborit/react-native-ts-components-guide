...
export const SwitchCustom = ({isOn, onChange}: SwitchCustomProps) => {
  ...
  return (
    <>
      ...
      <Switch
        trackColor={{false: '#c3c3c6', true: '#afaef9'}} // si se comenta, en Android se mira un poco feo y no se diferencia bien el switch
        thumbColor={
          Platform.OS === 'android' ? (isEnabled ? '#4746a5' : '#f4f3f4') : ''
